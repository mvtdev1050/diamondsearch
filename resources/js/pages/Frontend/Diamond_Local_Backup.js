    ...
    const AfterSubmit = () => {
        ...
        var data = {
            range:{
                ...
                color_from: demo.color[0],
                color_to: demo.color[1],
            ...
            <div className='cust-container'>
                ...
                <div className='range-options color-range'>
                    <div className="inner-range-options">
                        ...
                        <Range marks={marks} min={0} max={100} step={10}  defaultValue={range.color} onChange={(values) => handleRange(values, "color")}   />
                    ...
                    <div className="inner-range-options">
                        ...
                        <Range marks={marks} min={0} max={100} step={10} defaultValue={range.clarity} onChange={(values) => handleRange(values, "clarity")}   />
                        <ul className="steps-labels">
                            <li key={'12'}>12</li>
                            <li key={'I1'}>I1</li>
                            <li key={'S13'}>S13</li>
